          ...
          <div className="grid grid-cols-2 gap-6 lg:grid-cols-4">
            {features.map(({ icon: Icon, label }) => (
              <div key={label} className="flex flex-col items-center gap-3 text-center">
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-lion-green-900 text-lion-gold-400">
                  <Icon size={24} />
                </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-5">
            {ageGroups.map((group) => (
              <div
                key={group.id}
                className="rounded-2xl border border-lion-green-900/10 bg-white p-6 text-center shadow-sm sm:p-8"
              >
      ...
      <section className="bg-white py-20 sm:py-24">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div className="rounded-2xl border border-lion-green-900/10 bg-lion-green-900 p-8 text-white">
            ...
            <div className="rounded-2xl border border-lion-green-900/10 bg-lion-cream p-8">
