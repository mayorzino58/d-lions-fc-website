    ...
    <>
      ...
      <section className="bg-white py-20 sm:py-24">
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-4 sm:px-6 md:grid-cols-2 lg:px-8">
          <div className="rounded-2xl border border-lion-green-900/10 bg-lion-cream p-8 sm:p-10">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {coreValues.map((value, i) => (
              <div
                key={value.title}
                className="rounded-xl border border-lion-black/5 bg-white p-6 shadow-sm"
              >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2">
            {objectives.map((obj, i) => (
              <div
                key={obj.title}
                className="flex gap-4 rounded-xl border border-lion-gold-500/20 bg-white/5 p-6"
              >
